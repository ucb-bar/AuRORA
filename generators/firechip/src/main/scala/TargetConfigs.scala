...
//******************************************************************
// For Dcache/TLB swapping
// tightly integrated 1 core
...
// 16 KB cache
class FireSimGemminiReRoCC16DCache0tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC16DCache0tlbConfig)
class FireSimGemminiReRoCC16DCache512tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC16DCache512tlbConfig)
class FireSimGemminiReRoCC16DCache1024tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC16DCache1024tlbConfig)
class FireSimGemminiReRoCC16DCache2048tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC16DCache2048tlbConfig)
class FireSimGemminiReRoCC16DCache256tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC16DCache256tlbConfig)

// 4 KB cache
class FireSimGemminiReRoCC4DCache0tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC4DCache0tlbConfig)
class FireSimGemminiReRoCC4DCache512tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC4DCache512tlbConfig)
class FireSimGemminiReRoCC4DCache1024tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC4DCache1024tlbConfig)
class FireSimGemminiReRoCC4DCache2048tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC4DCache2048tlbConfig)
class FireSimGemminiReRoCC4DCache256tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC4DCache256tlbConfig)

// 2 KB cache
class FireSimGemminiReRoCC2DCache0tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC2DCache0tlbConfig)
class FireSimGemminiReRoCC2DCache512tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC2DCache512tlbConfig)
class FireSimGemminiReRoCC2DCache1024tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC2DCache1024tlbConfig)
class FireSimGemminiReRoCC2DCache2048tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC2DCache2048tlbConfig)
class FireSimGemminiReRoCC2DCache256tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC2DCache256tlbConfig)
// 1 KB cache
class FireSimGemminiReRoCC1DCache0tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC1DCache0tlbConfig)
class FireSimGemminiReRoCC1DCache512tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC1DCache512tlbConfig)
class FireSimGemminiReRoCC1DCache1024tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC1DCache1024tlbConfig)
class FireSimGemminiReRoCC1DCache2048tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC1DCache2048tlbConfig)
class FireSimGemminiReRoCC1DCache256tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC1DCache256tlbConfig)

// 0.5 KB cache
class FireSimGemminiReRoCC0p5DCache0tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC0p5DCache0tlbConfig)
class FireSimGemminiReRoCC0p5DCache512tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC0p5DCache512tlbConfig)
class FireSimGemminiReRoCC0p5DCache1024tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC0p5DCache1024tlbConfig)
class FireSimGemminiReRoCC0p5DCache2048tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC0p5DCache2048tlbConfig)
class FireSimGemminiReRoCC0p5DCache256tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC0p5DCache256tlbConfig)

// 8 KB cache
class FireSimGemminiReRoCC8DCache0tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC8DCache0tlbConfig)
class FireSimGemminiReRoCC8DCache512tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC8DCache512tlbConfig)
class FireSimGemminiReRoCC8DCache1024tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC8DCache1024tlbConfig)
class FireSimGemminiReRoCC8DCache2048tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC8DCache2048tlbConfig)
class FireSimGemminiReRoCC8DCache256tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC8DCache256tlbConfig)
// no dcache
class FireSimGemminiReRoCC0DCache0tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC0DCache0tlbConfig)
class FireSimGemminiReRoCC0DCache512tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC0DCache512tlbConfig)
class FireSimGemminiReRoCC0DCache1024tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC0DCache1024tlbConfig)
class FireSimGemminiReRoCC0DCache2048tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC0DCache2048tlbConfig)
class FireSimGemminiReRoCC0DCache256tlbConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiReRoCC0DCache256tlbConfig)
/*
class FireSimGemminiTightRocketNoCConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiTightRocketNoCConfig)
*/
class FireSimGemminiTightRocketConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiTightRocketConfig)

/*
class FireSimGemminiReRoCCConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiDummyReRoCCBaseConfig)


class FireSimGemminiReRoCCNoCConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiDummyReRoCCNoCConfig)
*/
class FireSimGemminiReRoCCNoCConfigdcachetlb extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiDummyReRoCCNoCConfig_dcachetlb)

class FireSimGemminiReRoCCNoCConfig3 extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiDummyReRoCCNoCConfig3)

class FireSimGemminiReRoCCNoCConfig2 extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiDummyReRoCCNoCConfig2)

class FireSimGemminiReRoCCConfigdcachetlb extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiDummyReRoCCBaseConfig_dcachetlb)
...
class FireSimGemmini10ReRoCCSharedNoCConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.Gemmini10ReRoCCSharedNoCConfig)
class FireSimGemmini10ReRoCCNoCConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.Gemmini10ReRoCCNoCConfig)

// 4 banks
class FireSimGemmini8ReRoCCConfig2 extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiDummy8ReRoCCBaseConfig2)

// 8 banks
class FireSimGemmini8ReRoCCConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiDummy8ReRoCCBaseConfig)


class FireSimGemminiMotiv2ReRoCCBaseConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiMotiv2ReRoCCBaseConfig)

class FireSimGemminiMotiv2ReRoCCSharedNoCConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiMotiv2ReRoCCSharedNoCConfig)

class FireSimGemminiMotiv2ReRoCCXbarNoCConfig extends Config(
  new WithDefaultFireSimBridges ++
  //new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.GemminiMotiv2ReRoCCXbarNoCConfig)
//**********************************************************************************
